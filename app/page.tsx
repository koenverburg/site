...
const link = (label: string, link: string) => (): JSX.Element => {
  return (
    <a
      href={link}
      target="_blank"
      className={`underline font-semibold text-orange-500 umami--click--${label
        .toLowerCase()
        .replace(".", "-")}`}
      rel="noreferrer"
    >
...
const Page = () => {
  ...
  const Instagram = link(
    "Instagram",
    "https://www.instagram.com/conradtheprogrammer/"
  );
    ...
    <Layout title="Conrad The Programmer">
      <div className="text-center mb-4">
        ...
        <h5 className="text-gray-500 mb-2">
          On Social Media as <Bold>Conrad The Programmer</Bold>
        </h5>
      </div>

      <article className="mb-4 text-center">
        I care about Developer Experience which includes a fast CI/CD, fast
        feedback loop during active development, repeatable and solid
        infrastructure using IaC, Docker and kubernetes.
        <br />
        <br />
        During the day I work on the ReactJS app that powers <AdidasCom />{" "}
        <br />
        At night I stream on <Twitch />, work on content for <Instagram /> or my{" "}
        <Blog />, or one of my SaaS projects.
      </article>
